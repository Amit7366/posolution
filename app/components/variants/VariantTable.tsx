      ...
      <table className="w-full min-w-[1100px]">
        <thead>
          <tr className="text-left text-sm text-gray-600 dark:text-slate-300">
            ...
            <th className="px-5 py-4 font-semibold text-gray-900 dark:text-gray-900 dark:text-slate-100">{t("dash.variants.colVariant")}</th>
            <th className="px-5 py-4 font-semibold text-gray-900 dark:text-gray-900 dark:text-slate-100">{t("dash.common.values")}</th>
        ...
        <tbody className="divide-y divide-white/10">
          {rows.map((r) => (
            <tr key={r.id} className="group hover:bg-gray-50 dark:bg-white/[0.03]">
              ...
              <td className="px-5 py-4 text-sm text-gray-600 dark:text-slate-300">{formatDate(r.createdAt)}</td>
