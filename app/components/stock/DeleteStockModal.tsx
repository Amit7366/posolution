  ...
  return (
    ...
    >
      <div className="flex flex-col items-center justify-center gap-4 py-6 text-center">
        ...
        <h3 className="text-2xl font-semibold text-slate-100">Delete Stock</h3>
        <p className="text-sm text-slate-300">Are you sure you want to delete product from stock?</p>
      </div>
    </Modal>
  );
}
