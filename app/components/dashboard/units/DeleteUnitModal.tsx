  ...
  return (
    ...
    >
      <div className="flex flex-col items-center justify-center gap-4 py-6 text-center">
        ...
        <h3 className="text-2xl font-semibold text-gray-900 dark:text-gray-900 dark:text-slate-100">{t("dash.units.deleteTitle")}</h3>
        <p className="text-sm text-gray-600 dark:text-slate-300">{body}</p>
      </div>
    </Modal>
  );
}
