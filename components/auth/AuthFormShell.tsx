...
export default function AuthFormShell({ children }: AuthFormShellProps) {
  ...
  return (
    <div className="relative flex h-full min-h-0 flex-1 flex-col overflow-y-auto bg-white">
      {/* Subtle grid pattern */}
      <div
        aria-hidden
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-md flex-1 flex-col justify-center px-6 py-8 sm:px-10 lg:px-12">
        <div className="mb-6 flex flex-col items-center text-center">
          <motion.div
            ...
            className="mb-4 flex h-14 w-14 items-center justify-center rounded-full border-2 border-gray-200 text-gray-400"
          >
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <p className="mt-2 text-sm text-gray-500">{t("auth.secureSubtitle")}</p>
            </motion.div>
          </AnimatePresence>
        </div>
